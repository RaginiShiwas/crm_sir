        ...
        <form class="mb-9">
          <div class="row justify-content-between align-items-end g-3 mb-5">
            ...
            <div class="col-12 col-sm-auto col-xl-4">
              <div class="d-flex">
                <button class="btn btn-phoenix-primary px-5 me-2">Save</button><a class="btn btn-primary px-5 w-100 text-nowrap" href="../../apps/events/event-detail.html">Publish event</a>
              </div>
            </div>
          </div>
          <div class="row g-5">
              ...
              <div class="row gx-3 gy-4">
                ...
                <div class="col-sm-6 col-md-12">
                  <div class="form-floating">
                    ...
                    <label for="floatingEventInput">Event title</label>
                  </div>
                </div>
                ...
                <h4 class="fs-1 mt-7">Schedule</h4>
                <div class="col-sm-6">
                  <div class="flatpickr-input-container">
                    <div class="form-floating">
                      <input class="form-control datetimepicker" id="startDatepicker" type="text" placeholder="start date" data-options='{"disableMobile":true}' /><span class="uil uil-calendar-alt flatpickr-icon text-700"></span>
                ...
                <div class="col-sm-6">
                  <div class="form-floating">
                    <input class="form-control datetimepicker" id="timepickerEvent" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                ...
                <div class="col-sm-6">
                  <div class="flatpickr-input-container">
                    <div class="form-floating">
                      <input class="form-control datetimepicker" id="endDatepicker" type="text" placeholder="end date" data-options='{"disableMobile":true}' /><span class="uil uil-calendar-alt flatpickr-icon text-700"></span>
                ...
                <div class="col-sm-6">
                  <div class="form-floating">
                    <input class="form-control datetimepicker" id="timepickerEvent2" type="text" placeholder="H:i" data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                ...
                <div class="col-sm-6">
                  <div class="flatpickr-input-container">
                    <div class="form-floating">
                      <input class="form-control datetimepicker" id="datepicker" type="text" placeholder="registration deadline" data-options='{"disableMobile":true}' />
                ...
                <div class="col-sm-6 gy-6">
                  <div class="form-floating">
                    <input class="form-control" id="floatingSponsorsInput" type="text" placeholder="SPONSORS" />
            ...
            <div class="col-xl-4">
              <div class="border-bottom pb-6 mb-6">
                ...
                <div class="form-check mb-2">
                  ...
                  <label class="form-check-label fw-normal" for="exampleRadios1">On Phoenix, our distribution partners, and search engines,<br />anybody can find the event </label>
                </div>
                <div class="form-check mb-0">
                  <input class="form-check-input" id="exampleRadios2" type="radio" name="exampleRadios" value="option2" />
                  <label class="form-check-label fw-normal" for="exampleRadios2">Only the individuals you select have access to it.</label>
                </div>
              </div>
              <div class="border-bottom mb-6">
                <div class="form-check">
                  <input class="form-check-input" id="flexChecked" type="checkbox" checked="checked" />
                  <label class="form-check-label fw-bold fs-0 mb-5" for="flexChecked">Show the number of available tickets</label>
                </div>
              </div>
              <h4 class="fs-1 mb-4">Ticket pricing</h4>
              <div class="form-check form-check-inline">
                <input class="form-check-input" id="freeTicket" type="radio" name="inlineRadioOptions" value="freeTicket" checked="checked" />
                <label class="form-check-label" for="freeTicket">Free</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" id="paidTicket" type="radio" name="inlineRadioOptions" value="paidTicket" />
              ...
              <div class="row g-3 mb-7 mt-1 border-bottom pb-5">
                <div class="col-6 col col-xl-7">
                  <h4 class="fs--1">Option</h4>
                </div>
                <div class="col-6 col-xl-5">
                  <h4 class="fs--1">Price</h4>
                </div>
                ...
                <div class="col-12">
                  <button class="btn btn-link p-0" type="button"><span class="fa-solid fa-plus me-2"></span>Add an option </button>
                </div>
              </div>
              <h4 class="fs-1 mb-3">Custom fields</h4>
              <div class="row g-3 mb-3">
                <div class="col-md-6 col-lg-12 col-xl-6">
                  <label class="form-label" for="inputName">Name</label>
                  <input class="form-control" id="inputName" type="text" placeholder="Item name (e.g. Special T-shirt)" />
                </div>
                <div class="col-md-6 col-lg-12 col-xl-6">
              ...
              <div class="row g-3">
                <div class="col-md-6 col-lg-12 col-xl-6">
                  ...
                  <input class="form-control" id="inputName2" type="text" placeholder="Item name (e.g. Special T-shirt)" />
                </div>
                <div class="col-md-6 col-lg-12 col-xl-6">
                ...
                <div class="col-12">
                  <button class="btn btn-link p-0" type="button"><span class="fa-solid fa-plus me-2"></span>Add an item</button>
                </div>
              </div>
            </div>
          </div>
