...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="manifest" href="{{asset('assets/dist/css/img/favicons/manifest.json')}}">
          ...
          <div class="row flex-center h-100 g-0 px-4 px-sm-0">
            ...
            <div class="mb-3 text-start">
              ...
              <div class="form-icon-container">
                <input class="form-control form-icon-input" id="username" name="username" type="text" placeholder="Email" required value="{{ old('username') }}" />
                 <span class="fas fa-user text-900 fs--1 form-icon"></span></div>
            </div>
            <div class="mb-3 text-start">
              <label class="form-label" for="password">Password</label>
              <div class="form-icon-container">
              <input class="form-control form-icon-input" id="password" name="user_password" type="password" placeholder="Password" required value="{{ old('user_password') }}" /><span class="fas fa-key text-900 fs--1 form-icon"></span>
              </div>
            </div>
            ...
            <div class="mb-3 text-start">
              ...
              <div class="form-icon-container">
               <select class="select2 form-control" name="finacial_year">
                ...
                <option value="{{$fy->id}}{{$fy->date_from}}{{$fy->date_to}}">{{$fy->date_from}} to {{$fy->date_to}}</option>
                @endforeach
              </select>
              </div>
            </div>
