...
<div class="content">
      ...
      <!--  <div class="row">
          <div class="col-xl-12 container-fluid">
            ...
            <h4 class="mb-3">Sales Order Register</h4>
            @if(session('success'))
            ...
            <div class="container-fluid">
                <form action="" method="POST" class="row g-3 mb-9">
                    @csrf
       ...
       <a href="{{ url('/sales_order_list') }}" class="btn btn-primary">Sales Order Register List</a>
             </div>
            </form>
           </div>
          </div>
