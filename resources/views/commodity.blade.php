        ...
        <div class="row">
          <div class="col-xl-12 container-fluid">
            ...
            <div class="container-fluid">
                <form action="{{ route('commodity.store') }}" method="POST" class="row g-3 mb-9">
                    @csrf
                <div class="col-sm-6 col-md-12 conatiner-fluid">
                <div class="form-floating">
                <textarea class="form-control" id="commodity_name" name="commodity_name" placeholder="Enter Commodity Name" style="height: 100px;">{{ old('commodity_name') }}</textarea>
              ...
              <div class="col-sm-6 col-md-12 conatiner-fluid">
                <div class="form-floating">
                <input type="text" class="form-control" id="commodity_code" name="commodity_code" placeholder="Enter Commodity Code" value="{{ old('commodity_code') }}">
