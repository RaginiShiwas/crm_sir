...
<div class="content">
    ...
    <!--    <div class="row">
        ...
        @endif
            ...
            <form action="{{ route('rfq_lead.store') }}" method="POST" class="row g-3 mb-9" autocomplete="on" enctype="multipart/form-data">
            @csrf
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
    <div class="form-floating">
        <select class="form-select" id="vendorname" name="customer_name" onChange="showCustomerDetail(this.value)">
    ...
    <div class="form-floating">
        ...
        <label for="floatingSelectOwner">Email</label>
    </div>
</div>

<div class="col-sm-6 col-md-6 conatiner-fluid" id="email_cc_container" >
    <div class="form-floating">
        <input type="text" class="form-control" id="email_cc" placeholder="Enter Email Cc" name="email_cc">
        <label for="floatingSelectOwner">Email Cc</label>
    </div>
</div>
             ...
             <div class="col-sm-6 col-md-6 conatiner-fluid">
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                  ...
                  <option selected disabled>Business Category</option>
                    @foreach($businessCategories as $id => $categoryName)
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                  ...
                  @foreach($plants as $id => $branchName)
            ...
            <div class="col-sm-6 col-md-6 conatiner-fluid">
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                ...
                <select class="form-select" id="partno" name="partno">
                    ...
                    @foreach($partNumbers as $id => $partNumber)
                        <option value="{{ $id }}">{{ $partNumber }}</option>
                    @endforeach
                </select>
                </div>
              </div>
             ...
             <div class="col-sm-6 col-md-6">
                ...
                <select class="form-select" id="partno" name="partdesc">
                    ...
                    @foreach($itemDescription as $id => $partDescription)
                        <option value="{{ $id }}">{{ $partDescription }}</option>
                    @endforeach
                </select>
                </div>
              </div>
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                <input type="date" class="form-control" id="feasiblity" name="feasiblity" placeholder="Feasibility received from Plant on">
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                <input type="date" class="form-control" id="latestquo" name="latestquo" placeholder="Latest complete Quotation received from Plant On">
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                <input type="date" class="form-control" id="latest_quo_cust" name="latest_quo_cust" placeholder="Latest Quotation submitted to customer on">
              ...
              <div class="col-sm-6 col-md-6 conatiner-fluid">
                <div class="form-floating">
                <input type="date" class="form-control" id="businessaward" name="businessaward" placeholder="Business Awarded Date">
