...
<div class="navbar-logo">
  ...
  <a class="navbar-brand navbar-brand" href="{{ url('/dashboard') }}">Panchisoft <span class="text-1000 d-none d-sm-inline">ERP</span></a>
</div>
<div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
  <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-0 me-2 uil-chart-pie"></span>RFQ's</a>
      <ul class="dropdown-menu navbar-dropdown-caret">
        <li><a class="dropdown-item" href="{{ url('/rfq_receipt') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="shopping-cart"></span>RFQ Receipt
            </div>
          </a>
        </li>
        <li><a class="dropdown-item" href="{{ url('/customer_cont') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="users"></span>Customer Contact
            </div>
          </a>
        </li>
          <li><a class="dropdown-item" href="{{ url('/item') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="package"></span>Product Master
            </div>
          </a>
        </li>
         <li><a class="dropdown-item" href="{{ url('/rfq') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="phone"></span>RFQ
            </div>
          </a>
        </li>
        <li><a class="dropdown-item" href="{{ url('/commodity') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="trello"></span>Commodity
            </div>
          </a>
        </li>
        <li><a class="dropdown-item" href="showcase.php">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="share-2"></span>RFQ's Register
            </div>
          </a>
        </li>        
      </ul>
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-0 me-2 uil-files-landscapes-alt"></span>CRM</a>
      <ul class="dropdown-menu navbar-dropdown-caret">
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-0 me-2 uil-files-landscapes-alt"></span>Sales</a>
      <ul class="dropdown-menu navbar-dropdown-caret">
      <li><a class="dropdown-item" href="{{ url('/sales_order') }}">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="share-2"></span>Sales Order Register
            </div>
          </a>
        </li>    
    ...
    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
      <span class="uil fs-0 me-2 uil-document-layout-right"></span>Marketing</a>
      <ul class="dropdown-menu navbar-dropdown-caret">
        <li><a class="dropdown-item" href="../documentation/getting-started.html">
            <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="life-buoy"></span>Getting started
            </div>
