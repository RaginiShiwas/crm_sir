        ...
        <div class="row">
          <div class="col-xl-12 container-fluid">
            ...
            <div class="container-fluid">
                <form action="<?php echo e(route('itemGroup.store')); ?>" method="POST" class="row g-3 mb-9">
                    <?php echo csrf_field(); ?>
                <div class="col-sm-6 col-md-4 conatiner-fluid">
                <div class="form-floating">
                <input type="text" class="form-control" id="item_name" name="itemname" placeholder="Item Name">
                <label for="item_name">Item Name</label>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 conatiner-fluid">
                <div class="form-floating">
                <input type="text" class="form-control" id="product_code" name="itemcode" placeholder="Enter Product Code">
                <label for="product_code">Product Code</label>
                </div>
              </div>
              <div class="col-sm-6 col-md-4 conatiner-fluid">
                <div class="form-floating">
                <input type="text" class="form-control" id="our_code" name="ourcode" placeholder="Our Code">
                ...
                <div class="form-floating">
                    <select class="form-select" id="item_group" name="itemgroupid">
                        ...
                        <?php $__currentLoopData = $itemGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $groupName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id); ?>"><?php echo e($groupName); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
              ...
              <div class="col-sm-6 col-md-4 conatiner-fluid">
                ...
                <select class="form-select" id="item_class" name="classid">
                    <option selected="selected">Item Class</option>
              ...
              <div class="col-sm-6 col-md-4 conatiner-fluid">
                <div class="form-floating">
                <select class="form-select" id="acc_group" name="itemgroupid">
                      <option selected="selected">Account Group</option>
                      <?php $__currentLoopData = $accountGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $groupname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($id); ?>"><?php echo e($groupname); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
              ...
              <div class="col-sm-6 col-md-4 conatiner-fluid">
                <div class="form-floating">
                <select class="form-select" id="item_loc" name="location">
                  <option selected="selected">Item Location</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\CRM_1\resources\views\item.blade.php ENDPATH**/ ?>