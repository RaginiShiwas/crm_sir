      ...
      <div class="row vh-100 g-0">
        ...
        <div class="col-lg-6">
          <div class="row flex-center h-100 g-0 px-4 px-sm-0">
            <div class="col col-sm-6 col-lg-7 col-xl-6"><a class="d-flex flex-center text-decoration-none mb-4" href="../pages/authentication/simple/index.php">
                <div class="d-flex align-items-center fw-bolder fs-5 d-inline-block"><img src="../assets/img/icons/logo.png" alt="phoenix" width="40" />
                </div>
              </a>
            <div class="mb-3 text-start">
              <label class="form-label" for="email">User Name</label>
              <div class="form-icon-container">
                <input class="form-control form-icon-input" id="username" name="username"  type="text" placeholder="User Name" ><span class="fas fa-user text-900 fs--1 form-icon"></span>
              </div>
            </div>
            <div class="mb-3 text-start">
              <label class="form-label" for="password">Password</label>
              <div class="form-icon-container">
                <input class="form-control form-icon-input" id="pass" name="password" type="pass" placeholder="Password" ><span class="fas fa-key text-900 fs--1 form-icon"></span>
              </div>
            </div>
            <div class="mb-3 text-start">
              <div class="form-icon-container">
                  <select class="form-control form-icon-input" id="financialYear" name="financialYear">
                      <option value="">Select Financial Year</option>
                      <?php $__currentLoopData = $financialYears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $date_from): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($id); ?>"><?php echo e($date_from); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <span class="fas fa-calendar-alt text-900 fs--1 form-icon"></span>
              </div>
          </div>
            ...
            <div class="row flex-between-center mb-7">
              ...
              <button type="submit" class="btn btn-primary w-100 mb-3" id="btn" name="btn">Sign In</button>
    ...
    <script>
     /* $(function () {
      ...
      $(document).ready(function(){
        // set yearid, f_date_from, f_date_to
        // on page load
        const fyearid = $("#fyearid").val();
        setFDate(fyearid);
      });

      // set financial year
      function setFDate(value) {
        $(document).ready(function(){
          if ( value == '' ){
            alert("Select financial year.");
            return;
          }
          const [yearid, date_from, date_to] = value.split(';');

          // set values
          $("#yearid").val(yearid);
          $("#f_date_from").val(date_from);
          $("#f_date_to").val(date_to);
...
</html><?php /**PATH E:\xampp\htdocs\CRM_1\resources\views\welcome.blade.php ENDPATH**/ ?>